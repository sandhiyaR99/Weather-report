...
function Weather() {
    ...
    return (
        <div className="relative">
            <img src={one} className="absolute inset-0 w-full h-screen object-cover blur-sm" alt="Background Image" />

            <div className="fixed top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="bg-white bg-opacity-90 border border-gray-300 rounded-xl p-5 w-96 text-center shadow-lg">
                    <h1 className="text-4xl font-bold mb-4 text-blue-700 ">Weather Report</h1>
                    <p className="text-lg mb-4 text-gray-700">Enter your city for weather details.</p>
